...
from src.optimizers import (
    ...
    TrustBayesianGradientAscent,
    MIBayesianGradientAscent
)
from src.model import ExactGPSEModel, DerivativeExactGPSEModel,  MIDerivativeExactGPSEModel
from src.acquisition_function import optimize_acqf_vanilla_bo, optimize_acqf_custom_bo, optimize_acqf_MI_bo
...
insertion_config = {
    "method": {
        "s-hci-gibo": MIBayesianGradientAscent,
        "hci-gibo": TrustBayesianGradientAscent,
