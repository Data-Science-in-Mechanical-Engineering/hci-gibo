...
def loop(
    ...
    Optimizer: Union[RandomSearch, BayesianGradientAscent, VanillaBayesianOptimization, MIBayesianGradientAscent],
...
def loop_IS(
    ...
    return optimizer.params_history_list, calls_in_iteration, optimizer.sampled_point_list
